        ...
        <div className="px-12 mx-auto max-w-7xl">
          <div className="w-full mx-auto text-left md:w-11/12 xl:w-9/12 md:text-center">
            <h1 className="mb-8 text-4xl font-extrabold leading-none tracking-normal text-neutral-900 md:text-6xl md:tracking-tight">
              <span>¿Buscas</span>
              <span className="block w-full py-2 text-transparent bg-clip-text leading-12 bg-gradient-to-r from-sky-400 to-purple-500 lg:inline"> nuevas historias</span>
              <span> o quieres</span>
              <span className="block w-full py-2 text-transparent bg-clip-text leading-12 bg-gradient-to-r from-sky-400 to-purple-500 lg:inline"> compartir</span>
            ...
            <div className="mb-4 space-x-0 md:space-x-2 md:mb-8">
              <Link to="/signin" className="inline-flex items-center justify-center w-full px-6 py-3 mb-2 text-lg text-white bg-sky-400 rounded-2xl sm:w-auto sm:mb-0">
                Entrar
              </Link>
              <Link to="/signup" className="inline-flex items-center justify-center w-full px-6 py-3 mb-2 text-lg bg-neutral-100 rounded-2xl sm:w-auto sm:mb-0">
                Crear cuenta
              </Link>
            </div>
          </div>
      ...
      <section className="bg-white dark:bg-neutral-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div className="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
            <h2 className="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-neutral-900 dark:text-white">Últimas publicaciones</h2>
          </div>
          <div className="flex flex-col flex-wrap gap-8 items-center justify-center mx-auto md:flex-row">
            {latestPost.map(post => (
              <div key={post} role="status" className="animate-pulse md:p-6 p-6 bg-white rounded-lg border border-neutral-200 shadow-md dark:bg-neutral-800 dark:border-neutral-700">
                <div className="flex items-center justify-center h-48 mb-4 bg-neutral-300 rounded dark:bg-neutral-700">
                  <TbPhotoFilled className="w-10 h-10 text-neutral-200 dark:text-neutral-600" />
                </div>
                ...
                <div className="flex items-center mt-4">
                  <TbUserCircle className="w-10 h-10 me-3 text-neutral-200 dark:text-neutral-700" />
                  <div>
      ...
      <section className="bg-white dark:bg-neutral-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
          <div className="mx-auto mb-8 max-w-screen-sm lg:mb-16">
            <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-neutral-900 dark:text-white">Escritores destacados</h2>
          </div>
          <div className="grid gap-8 lg:gap-16 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 animate-pulse">
            {featuredWriters.map(writer => (
              <div key={writer} className="flex flex-col items-center">
                <TbUserCircle className="text-neutral-200 dark:text-neutral-700 mx-auto mb-4 w-36 h-36 rounded-full" />
                <div className="h-6 bg-neutral-200 rounded-full dark:bg-neutral-700 w-48 mb-2"></div>
                <div className="h-4 bg-neutral-200 rounded-full dark:bg-neutral-700 w-48 mb-4"></div>
                <ul className="flex justify-center mt-4 space-x-4">
                  <li>
                    <TbPhotoFilled className="w-6 h-6 me-3 text-neutral-200 dark:text-neutral-700" />
                  </li>
                  <li>
                    <TbPhotoFilled className="w-6 h-6 me-3 text-neutral-200 dark:text-neutral-700" />
                  </li>
            ...
            <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-2 gap-x-2 gap-y-2 lg:gap-x-6 md:gap-x-6 md:gap-y-6">
              <div className="flex justify-center flex-col items-center w-36 h-36 md:w-44 md:h-48 lg:w-56 lg:h-56 bg-white shadow rounded-2xl">
                <div className="flex flex-col items-center justify-center">
                  ...
                  <dd className="text-sm md:text-base lg:text-lg leading-none text-center text-neutral-600">publicaciones</dd>
                </div>
              </div>
              <div className="flex justify-center flex-col items-center w-36 h-36 md:w-44 md:h-48 lg:w-56 lg:h-56 bg-white shadow rounded-2xl">
                <div className="flex flex-col items-center justify-center">
                  <dt className="mb-2 text-4xl md:text-5xl font-extrabold">73M+</dt>
                  <dd className="text-sm md:text-base lg:text-lg leading-none text-center text-neutral-600">escritores</dd>
                </div>
                ...
                <div className="flex flex-col items-center justify-center">
                  <dt className="mb-2 text-4xl md:text-5xl font-extrabold">73M+</dt>
                  <dd className="text-sm md:text-base lg:text-lg leading-none text-center text-neutral-600">temas</dd>
                </div>
              </div><div className="flex justify-center flex-col items-center w-36 h-36 md:w-44 md:h-48 lg:w-56 lg:h-56 bg-white shadow rounded-2xl">
                <div className="flex flex-col items-center justify-center">
                  <dt className="mb-2 text-4xl md:text-5xl font-extrabold">73M+</dt>
                  <dd className="text-sm md:text-base lg:text-lg leading-none text-center text-neutral-600">lecturas</dd>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-white dark:bg-neutral-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-6">
          <div className="mx-auto max-w-screen-sm">
            <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-neutral-900 dark:text-white">Testimonios</h2>
          </div>
      ...
      <section className="bg-white dark:bg-neutral-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div className="mx-auto max-w-screen-md sm:text-center">
            <h2 className="mb-4 text-3xl tracking-tight font-extrabold text-neutral-900 sm:text-4xl dark:text-white">Suscríbete a nuestra newsletter</h2>
            <form action="#">
              <div className="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                <div className="relative w-full">
                  <label htmlFor="email" className="hidden mb-2 text-sm font-medium text-neutral-900 dark:text-neutral-300">Correo</label>
                  ...
                  <input className="block p-3 pl-10 w-full text-sm text-neutral-900 bg-neutral-50 rounded-lg border border-neutral-300 sm:rounded-none sm:rounded-l-lg focus:ring-sky-500 focus:border-sky-500 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-sky-500 dark:focus:border-sky-500" placeholder="Introduce tu correo electrónico" type="email" id="email" required />
                </div>
                <div>
                  <button type="submit" className="py-3 px-5 w-full text-sm font-medium text-center text-white rounded-lg border cursor-pointer bg-sky-700 border-sky-600 sm:rounded-none sm:rounded-r-lg hover:bg-sky-800 focus:ring-4 focus:ring-sky-300 dark:bg-sky-600 dark:hover:bg-sky-700 dark:focus:ring-sky-800">Suscribir</button>
                </div>
              </div>
              <div className="mx-auto max-w-screen-sm text-sm text-left text-neutral-500 newsletter-form-footer dark:text-neutral-300">Nos preocupamos por la protección de tus datos. <a href="#" className="font-medium text-sky-600 dark:text-sky-500 hover:underline">Lea nuestra Política de Privacidad</a>.</div>
            </form>
          </div>
        </div>
      </section>
      {/* FOOTER */}
      <footer className="bottom-0 left-0 z-20 w-full p-4 bg-white border-t border-neutral-200 shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-neutral-800 dark:border-neutral-600">
        <span className="text-sm text-neutral-500 sm:text-center dark:text-neutral-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">One Blog™</a>. All Rights Reserved.
        </span>
