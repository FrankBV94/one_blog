    ...
    <main className='overflow-auto custom-scrollbar'>
      ...
      <section className="bg-white dark:bg-neutral-900">
        <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
          <div className="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
            <h2 className="mb-4 text-3xl lg:text-4xl tracking-tight font-extrabold text-neutral-900 dark:text-white">Lo último de One Blog</h2>
          </div>
      ...
      <footer className="p-4 bg-white md:p-8 lg:p-10 dark:bg-neutral-800">
        <div className="mx-auto max-w-screen-xl text-center">
          ...
          <span className="text-sm text-neutral-500 sm:text-center dark:text-neutral-400">© 2021-2022 <a href="#" className="hover:underline">Flowbite™</a>. All Rights Reserved.</span>
        </div>
      </footer>
    </main>
  )
